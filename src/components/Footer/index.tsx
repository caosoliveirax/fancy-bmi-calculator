    ...
    <FooterContainer role="contentinfo" $isResultVisible={isHiddenOnResult}>
      <LinksWrapper>
        ...
        <SocialLink
          ...
          href="https://github.com/caosoliveirax/fancy-bmi-calculator"
          target="_blank"
          rel="noopener noreferrer"
        >
          <p>Visitar repositório no Github</p>
          <svg
            aria-hidden="true"
            viewBox="0 0 15 15"
            fill="none"
        ...
        <SocialLink
          ...
          rel="noopener noreferrer"
        >
          <p>Visitar perfil no LinkedIn</p>
          <svg
            aria-hidden="true"
            viewBox="0 0 15 15"
            fill="none"
      ...
      <Copyright>&copy; {new Date().getFullYear()} Desenvolvido por Carlos Oliveira</Copyright>
    </FooterContainer>
  )
}
